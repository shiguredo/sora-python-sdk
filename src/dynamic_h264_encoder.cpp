...
// Helper method used by DynamicH264Encoder::Encode.
...
DynamicH264Encoder::~DynamicH264Encoder() {
  Release();
}

int32_t DynamicH264Encoder::InitEncode(const VideoCodec* inst,
...
int32_t DynamicH264Encoder::Release() {
...
int32_t DynamicH264Encoder::RegisterEncodeCompleteCallback(
    EncodedImageCallback* callback) {
  encoded_image_callback_ = callback;
  return WEBRTC_VIDEO_CODEC_OK;
}

void DynamicH264Encoder::SetRates(const RateControlParameters& parameters) {
  if (encoders_.empty()) {
...
int32_t DynamicH264Encoder::Encode(
...
// in InitializeExt.
SEncParamExt DynamicH264Encoder::CreateEncoderParams(size_t i) const {
...
void DynamicH264Encoder::ReportInit() {
  if (has_reported_init_)
    return;
  RTC_HISTOGRAM_ENUMERATION("WebRTC.Video.DynamicH264Encoder.Event",
                            kH264EncoderEventInit, kH264EncoderEventMax);
  has_reported_init_ = true;
}

void DynamicH264Encoder::ReportError() {
...
VideoEncoder::EncoderInfo DynamicH264Encoder::GetEncoderInfo() const {
  EncoderInfo info;
...
void DynamicH264Encoder::LayerConfig::SetStreamState(bool send_stream) {
...
bool DynamicH264Encoder::InitOpenH264() {
...
void DynamicH264Encoder::ReleaseOpenH264() {
  if (openh264_handle_ != nullptr) {
